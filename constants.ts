...
export const BOOKS: Book[] = [
  {
    ...
    author: 'Elara Vance',
    coverImage: 'https://picsum.photos/id/10/384/576', // Changed from Unsplash, updated resolution
  ...
  },
  {
    ...
    coverImage: 'https://picsum.photos/id/20/384/576', // Changed from Unsplash, updated resolution
  ...
  },
  {
    ...
    coverImage: 'https://picsum.photos/id/30/384/576', // Changed from Unsplash, updated resolution
  ...
  },
  {
    ...
    author: 'Jian Li',
    coverImage: 'https://picsum.photos/id/40/384/576', // Changed from Unsplash, updated resolution
